...
const hobbies = [
  {
    id: "hob-1",
    title: "",
    desc: [`Depuis 2022, la course à pied et le trail renforcent mon autodiscipline, ma détermination et ma gestion du stress: des atouts que j'applique au quotidien professionnel.`],
  },
];
